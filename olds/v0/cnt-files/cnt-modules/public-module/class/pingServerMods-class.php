...
class pingServer_modules
{
    ...
    public function arrayListServers($swit)
    {
        ...
        switch ($swit) 
        {
            case 'batua': $tableArray = array("172.16.0.1", "172.16.0.3", "172.16.0.4", "172.16.0.8", "172.16.0.10", "172.16.0.11", "172.16.0.12", "172.16.0.14", "172.16.0.18", "172.16.0.19", "172.16.0.20", "172.16.0.21", "172.16.0.22", "172.16.0.25", "172.16.0.30", "172.16.0.31", "172.16.0.32", "172.16.0.33", "172.16.0.36", "172.16.0.51", "172.16.0.55", "172.16.0.77", "172.16.0.87", "172.16.0.100", "172.16.0.101", "172.16.0.102", "172.16.0.103", "172.16.0.120"); break;
            case 'hasegawa': $tableArray = array("172.16.0.105", "172.16.0.106", "172.16.0.107", "172.16.0.108", "172.16.0.109", "172.16.0.110", "172.16.0.111", "172.16.0.112", "172.16.0.113", "172.16.0.114", "172.16.0.115", "172.16.0.116", "192.168.1.151", "192.168.1.153", "192.168.1.152", "192.168.1.154", "192.168.1.155", "192.168.1.157", "192.168.1.158", "192.168.1.200", "192.168.1.243"); break;
            case 'batua-sendMail': $tableArray = array("172.16.0.1", "172.16.0.3", "172.16.0.4", "172.16.0.8", "172.16.0.10", "172.16.0.11", "172.16.0.12", "172.16.0.14", "172.16.0.18", "172.16.0.19", "172.16.0.20", "172.16.0.21", "172.16.0.22", "172.16.0.25", "172.16.0.30", "172.16.0.31", "172.16.0.32", "172.16.0.33", "172.16.0.36", "172.16.0.51", "172.16.0.55", "172.16.0.58", "172.16.0.77", "172.16.0.87", "172.16.0.100", "172.16.0.101", "172.16.0.102", "172.16.0.103", "172.16.0.120"); break;
    ...
    { $ips = unserialize($entry); date_default_timezone_set('America/Sao_Paulo');
        ...
        $bds .= '<tbody>';
        for ($i=0; $i < count($ips); $i++)
        { $bds .= '<tr> <td>'.$ips[$i].'</td> <td>FALHA NA ENTREGA DO PACOTE</td> <td>'.date('d/m/Y')." ".(intval(date('H'))-1).":".date("s").":".date("i").'</td> </tr>'; }    
        $bds .= '</tbody> </table>';
        $mail->Body = $bds;
